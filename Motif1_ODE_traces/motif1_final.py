...
def ffe(Istim1 = 2,  Ko_rest = 4, forward_syn_weight = 10, extrasyn_glu = 0.0, atp = 20, del_phi_mito=180, 
    ...
    ngv_model.pars = { #Fixed nernst potentials mV
                    ...
                    #Receptors, synaptic, stroke
                        ...
                        'gnmdar': 0.02, #0.03, changed for exp2 mS/cm2
                        'gampa' : 0.01, #mS/cm2
                    ...
                    #neuromodulation, 
                        ...
                        'delta_D':0.6, #ms, pulse width also changable
                        'i_dbs':Amp_dbs, 
